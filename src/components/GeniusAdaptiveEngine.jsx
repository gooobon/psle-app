  ...
  "P3": {
    "English": {
      ...
      "WA3": {
        ...
        topicTags: {
          A: ["Synonyms","Antonyms","Phrasal Verbs","Word Families","Compound Words"],
          B: ["Tenses","Articles","Prepositions","Conjunctions","Pronouns","Subject-Verb Agreement"],
          C: ["Context Clues","Vocabulary in Context","Discourse Markers","Pronoun Reference"],
          D: ["Passive Voice","Reported Speech","Conditional","Combining Sentences"],
          E: ["Inference","Main Idea","Character Traits","Cause & Effect","Author's Purpose"],
        },
        trapTypes: {
          A: ["Confusable Words","Register Mismatch","False Cognates"],
          B: ["SVA with Collective Nouns","Irregular Past Tense","Conjunction Mismatch"],
          C: ["Conjunction Mismatch (however vs so)","Pronoun Disagreement","Wrong Tense Context"],
          D: ["Tense Shift","Active-Passive Inversion","Object Pronoun Change"],
          E: ["Answer in Present instead of Past Tense","Lifting text without changing pronouns","Missing 'Why' in Why-question"],
        },
      },
      "EOY": {
        label: "P3 English EOY",
        sections: [
          { id:"A", title:"Vocabulary MCQ",           count:5,  type:"mcq",   hasTrap:true  },
          { id:"B", title:"Grammar Cloze",             count:10, type:"cloze", hasTrap:true  },
          { id:"C", title:"Comprehension Cloze",       count:10, type:"cloze", hasTrap:true  },
          { id:"D", title:"Synthesis & Transformation",count:5,  type:"open",  hasTrap:true  },
          { id:"E", title:"Comprehension OEQ",         count:10, type:"open",  hasTrap:true  },
          { id:"F", title:"Continuous Writing",        count:1,  type:"open",  hasTrap:false },
        ],
        topicTags: {
          A: ["Synonyms","Antonyms","Phrasal Verbs","Idioms","Collocations"],
          B: ["Tenses","Passive Voice","Reported Speech","Relative Clauses","Conditional","Modal Verbs"],
          C: ["Context Clues","Vocabulary in Context","Discourse Markers","Cohesive Devices"],
          D: ["Passive Voice","Reported Speech","Conditional","Gerund vs Infinitive"],
          E: ["Inference","Main Idea","Character Traits","Cause & Effect","Author's Purpose","Tone"],
          F: ["Narrative Writing","Descriptive Writing","Personal Recount"],
        },
        trapTypes: {
          A: ["Confusable Words","Register Mismatch","Idiom Misuse"],
          B: ["Perfect Tenses","SVA with Collective Nouns","Stative Verbs in Continuous"],
          C: ["Conjunction Mismatch (however vs so)","Pronoun Disagreement","Wrong Tense Context"],
          D: ["Tense Shift","Subject Change in Transformation","Missing Connector"],
          E: ["Answer in Present instead of Past Tense","Lifting text without changing pronouns","Inferring beyond given evidence"],
          F: [],
        },
      },
    },
    "Mathematics": {
      ...
      "WA2": { label:"P3 Maths WA2", sections:[], topicTags:{}, trapTypes:{} },
      "WA3": { label:"P3 Maths WA3", sections:[], topicTags:{}, trapTypes:{} },
      "EOY": { label:"P3 Maths EOY", sections:[], topicTags:{}, trapTypes:{} },
    },
    "Chinese": {
      "WA1": {
      ...
      "WA2": { label:"P3 Chinese WA2", sections:[], topicTags:{}, trapTypes:{} },
      "WA3": { label:"P3 Chinese WA3", sections:[], topicTags:{}, trapTypes:{} },
      "EOY": { label:"P3 Chinese EOY", sections:[], topicTags:{}, trapTypes:{} },
    },
  },
  "P4": {
    "English": {
      ...
      "WA2": {
        ...
        topicTags: {
          A: ["Synonyms","Antonyms","Phrasal Verbs","Idioms"],
          B: ["Tenses","Passive Voice","Reported Speech","Relative Clauses"],
          C: ["Context Clues","Vocabulary in Context","Discourse Markers"],
          D: ["Conditional","Gerund vs Infinitive","Passive-Active Transformation"],
          E: ["Inference","Main Idea","Author's Purpose","Tone"],
        },
        trapTypes: {
          A: ["Confusable Words","Idiom Misuse","Register Mismatch"],
          B: ["Perfect Tenses","Passive Voice Errors","Relative Pronoun Choice"],
      ...
      "WA3": { label:"P4 English WA3", sections:[], topicTags:{}, trapTypes:{} },
      "EOY": { label:"P4 English EOY", sections:[], topicTags:{}, trapTypes:{} },
    },
  },
