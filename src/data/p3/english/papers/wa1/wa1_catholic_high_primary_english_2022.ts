...
export const wa1CatholicHighPrimaryEnglish2022: EnglishPaper = {
  ...
  items: [
    // Section A: Grammar MCQ (10 x 1m) Q1-10
    {
      ...
      answer: '1',
      solution: { method: '"every Saturday morning"(매주 토요일)이라는 반복 습관과 복수 주어를 본다.', steps: ['"Max and his friend"는 복수.', '"every Saturday morning"은 반복 습관 → 단순현재, 복수 주어 → 동사 원형.', 'cycle(복수 주어 단순현재) → 정답 (1).'], tip: '"every + 시간 표현"은 단순현재 반복 동작을 나타냅니다.' },
    },
    {
    ...
    },
    {
      ...
      answer: '4',
      solution: { method: '"rang"(과거)가 일어났을 때 진행 중이던 동작을 고른다.', steps: ['"rang"는 과거의 한순간.', 'Mother는 그 순간 요리하는 "중"이었다 → 과거진행형.', '단수 → was cooking → 정답 (4).'], tip: '"when + 과거 사건"에서 진행 중이던 동작은 was/were -ing입니다.' },
    },
    {
      ...
      answer: '3',
      solution: { method: '"It has been [기간] + ___"에 맞는 접속사를 고른다.', steps: ['"It has been five years since she left"(그녀가 떠난 이후 5년이 됐다) — 정해진 표현.', '"since" = ~한 이후로 → 정답 (3).'], tip: '"It has been [기간] since [과거 사건]"은 "~한 이후 [기간]이 됐다"라는 뜻입니다.' },
    },
    {
    ...
    // Section B: Vocabulary MCQ (10 x 1m) Q11-20
    {
      ...
      answer: '1',
      solution: { method: '"경찰 사이렌을 듣고 뒷문으로 빠르게 도망쳤다"에 맞는 동사를 고른다.', steps: ['"heard the police siren"(경찰 사이렌) → 급하게 도망침.', '"bolted" = 급히 달아나다 → 정확히 일치 → 정답 (1).'], tip: '"bolt"는 두려움에 급히 달아나는 동작입니다.' },
    },
    {
      ...
      answer: '4',
      solution: { method: '"불만족스러운 서비스에 대해 주인에게"라는 상황에 맞는 동사를 고른다.', steps: ['"unhappy with the service"(불만족) → 불평함.', '"grumbled about" = ~에 대해 투덜거리다/불평하다 → 정확히 일치 → 정답 (4).'], tip: '"grumble about"는 무언가에 대해 투덜거리는 동작입니다.' },
    },
    {
      ...
      answer: '3',
      solution: { method: '"매우 배고파서 케이크를 허겁지겁 먹었다"에 맞는 부사를 고른다.', steps: ['"very hungry"(매우 배고픔) + "gobbled"(허겁지겁 먹다) → 탐욕스럽게/욕심껏.', '"greedily" = 탐욕스럽게, 욕심껏 → 정확히 일치 → 정답 (3).'], tip: '"gobble + greedily"는 배고픔에 욕심껏 먹는 모습을 강조합니다.' },
    },
    {
      ...
      answer: '4',
      solution: { method: '"숙제를 하려고 하는데 볼륨을 어떻게 해달라"는 문맥을 파악한다.', steps: ['"I\'m trying to do my homework"(숙제 중) → 조용히 해달라 → 볼륨을 줄여달라.', '"turn down the volume" = 볼륨을 줄이다 → 정답 (4).'], tip: '"turn down"은 볼륨·온도 등을 줄이는 동작입니다.' },
    },
    {
      ...
      answer: '1',
      solution: { method: '"안경 없이 볼 수 없다"는 특성과 맞는 동물 직유를 고른다.', steps: ['"unable to read without his glasses"(안경 없이 못 봄) → 시력이 매우 나쁨.', '"as blind as a bat" = 박쥐처럼 눈이 나쁜 → 정해진 직유 → 정답 (1).'], tip: '"as blind as a bat"은 눈이 매우 나쁜 것을 나타내는 정해진 직유입니다.' },
    },
    {
      ...
      answer: '2',
      solution: { method: '"곧 비가 올 것 같다"는 문맥에서 손에 떨어진 것을 나타내는 단어를 고른다.', steps: ['"it might rain soon"(곧 비가 올 것) → 비 한 방울이 손에 떨어짐.', '"a drop of water" = 물 한 방울 → 정확히 일치 → 정답 (2).'], tip: '"a drop of water"는 물 한 방울로, 비가 시작될 때 느끼는 것입니다.' },
    },
    {
    ...
    },
    {
      ...
      answer: '3',
      solution: { method: '"뜨거운 커피를 쏟았다"는 결과로 생기는 부상을 고른다.', steps: ['"spilled hot coffee"(뜨거운 커피를 쏟음) → 화상.', '"scalded" = (뜨거운 액체로) 화상을 입다 → 정답 (3).'], tip: '"scald"는 뜨거운 액체나 증기로 화상을 입는 것을 나타냅니다.' },
    },
    {
      ...
      answer: '4',
      solution: { method: '"선생님 없을 때 반을 돌본다"는 특성에 맞는 형용사를 고른다.', steps: ['"You can trust him to take care of the class"(믿고 맡길 수 있음) → 책임감 있는.', '"responsible" = 책임감 있는 → 정확히 일치 → 정답 (4).'], tip: '"trust him to take care"는 책임감(responsible)의 특성을 나타냅니다.' },
    },
    {
      ...
      answer: '4',
      solution: { method: '"건강에 ___ 하다"는 표현에 맞는 형용사를 고른다.', steps: ['"Smoking is ___ to your health" → 건강에 해롭다.', '"harmful to health" = 건강에 해로운 → 정확히 일치 → 정답 (4).'], tip: '"harmful to"는 건강·환경에 해롭다는 정해진 표현입니다.' },
    },
    // Section C: Grammar Cloze (5 x 1m) Q21-25
    {
      ...
      questions: [
        { questionNo: '21', format: 'fib', marks: 1, stem: 'She told (21) ________ that we would be participating...', answer: 'D',
          solution: { method: 'Miss Yeo가 "우리(반 학생들)"에게 말했다.', steps: ['"우리를"이라는 목적격 → us.', '보기 (D) us → 정답 (D).'], tip: 'us = 우리를(1인칭 복수 목적격)' } },
        { questionNo: '22', format: 'fib', marks: 1, stem: 'order only what (22) ________ could finish', answer: 'E',
          solution: { method: '"우리가 먹을 수 있는 것만" → 주어는 "we".', steps: ['"우리가 다 먹을 수 있는 것만" → we.', '보기 (E) we → 정답 (E).'], tip: 'we = 우리가(1인칭 복수 주격)' } },
        { questionNo: '23', format: 'fib', marks: 1, stem: 'I told (23) ________ mother about the campaign.', answer: 'C',
          solution: { method: '"나의 엄마"라는 소유격.', steps: ['"told ___ mother" → "나의 엄마에게" → my.', '보기 (C) my → 정답 (C).'], tip: 'my = 나의(1인칭 단수 소유격)' } },
        { questionNo: '24', format: 'fib', marks: 1, stem: 'She was happy as (24) ________ will teach me good eating habits.', answer: 'B',
          solution: { method: '"캠페인"을 가리키는 주어를 고른다.', steps: ['"it(캠페인이) will teach me good eating habits" → it.', '보기 (B) it → 정답 (B).'], tip: '"the campaign"(단수 사물)을 받는 주어 대명사는 it입니다.' } },
        { questionNo: '25', format: 'fib', marks: 1, stem: 'The next day, (25) ________ waited for Miss Yeo to give me more details about the campaign.', answer: 'A',
          solution: { method: '"나(화자)는 Miss Yeo를 기다렸다"의 주어.', steps: ['"I waited for Miss Yeo" → I.', '보기 (A) I → 정답 (A).'], tip: '화자 자신이 주어이면 I를 씁니다.' } },
      ],
    },
